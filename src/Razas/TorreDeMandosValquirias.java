 ...
 * @author Jorge
 */
public class TorreDeMandosValquirias implements Razas{
    int capLeve1;
    int capLeve2;
    int capLeve3;
    int LifePointsValquirias;
    ...
    public int getLifePointsNornas() {
        return LifePointsValquirias;
    }
    ...
    public void setLifePointsValquirias (int LifePointsValquirias) {
        this.LifePointsValquirias = LifePointsValquirias;
    }
    ...
    public void creaTorreDeMandoValquirias(int capacity, int vida) {
        System.out.println("La Torre De control Valquirias esta creada");  
        this.capLeve1 = capacity;
        this.capLeve2 = capacity;
        this.capLeve3 = capacity;
        this.LifePointsValquirias = vida;
    }
