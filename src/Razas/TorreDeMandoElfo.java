 ...
 * @author Jorge
 */
public class TorreDeMandoElfo implements Razas {
    int capLeve1;
    int capLeve2;
    int capLeve3;
    int LifePointsElfo;

    public TorreDeMandoElfo() {
    }
    ...
    public void setLifePointsElfo(int LifePointsElfo) {
        this.LifePointsElfo = LifePointsElfo;
    }
    ...
    public void creaTorreDeMandoElfo(int capacity, int vida) {
        System.out.println("La Torre De control Elfo esta creada");  
        this.capLeve1 = capacity;
        this.capLeve2 = capacity;
        this.capLeve3 = capacity;
        this.LifePointsElfo = vida;
    }
